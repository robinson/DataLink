...
namespace DataLink.Driver.S7
{
    ...
    {
        private static int BufSize = 96;
        // MilliSeconds between 1970/1/1 (.NET time base) and 1984/1/1 (Siemens base)
        private long DeltaMilliSecs = 441763200000L;
        ...
        public DateTime CodeDate()
        {
            ...
            return new DateTime(BlockDate);
        }
        public DateTime IntfDate()
        {
